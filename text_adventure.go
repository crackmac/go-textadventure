...
// homework
// NPCs (non player character) - talk to them, fight
// NPC move around the graph
// items that can be picked up or placed down
// accept natural language as input (verb and noun, direction)
//
...
func (node *storyNode) executeCmd(cmd string) *storyNode {
	...
	fmt.Println("Sorry, I didn't undserstand that.")
	return node
}
...
func main() {
	...
	To the south, a passage appears to head upward. The eastern passage apears
	...
	start.addChoice("S", "Go Sount", &darkRoom)
	...
	darkRoomLit.addChoice("S", "Go Sount", &start)
